...
<td><input type="button" name="search_button" value="去查詢" onClick="window.open('http://tw100018629/L8BI0_WEB/FIB/search_defect.asp','_self')" style="background-color:rgb(245, 168, 53)"  size="60"><br></td>&nbsp;&nbsp;
